...
START_TEST(sprintf_test_short_hex) {
  ...
  char str2[BUFF_SIZE] = {0};
  char *format = "%hx";
  ck_assert_int_eq(s21_sprintf(str1, format, (unsigned)INT32_MIN),
                   sprintf(str2, format, (unsigned)INT32_MIN));
  ck_assert_str_eq(str1, str2);
  ck_assert_int_eq(s21_sprintf(str1, "%x", 0), sprintf(str2, "%x", 0));
  ck_assert_str_eq(str1, str2);
  format = "%hhx";
  ck_assert_int_eq(s21_sprintf(str1, format, INT32_MAX),
                   sprintf(str2, format, INT32_MAX));
  ck_assert_str_eq(str1, str2);
}
END_TEST
